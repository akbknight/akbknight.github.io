...
import { Code2, TrendingUp, Cpu, Briefcase } from "lucide-react";
...
export const SplitHero = () => {
    return (
        <div className="relative w-full min-h-[500px] flex flex-col md:flex-row items-stretch justify-center overflow-hidden rounded-3xl border border-white/5 bg-black/50 backdrop-blur-xl mb-12 group">
            ...
            <div className="flex-1 relative p-8 md:p-12 flex flex-col justify-center items-start border-b md:border-b-0 md:border-r border-white/5 bg-gradient-to-br from-blue-950/20 to-transparent">
            ...
            <div className="flex-1 relative p-8 md:p-12 flex flex-col justify-center items-end text-right bg-gradient-to-bl from-amber-950/20 to-transparent">
                <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 mix-blend-overlay pointer-events-none"></div>
